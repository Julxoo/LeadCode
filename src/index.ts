  ...
  ({ projectPath, language }) => {
    ...
    const steps = isFr
      ? [
          ...
          "",
          "## Étape 4 : Conventions cross-stack unifiées",
          "",
          "À partir de TOUTES les docs récupérées + les crossQueries de tech-queries,",
          ...
          "",
          "## Étape 5 : Construire le JSON docs",
          "",
      ...
      : [
          ...
          "",
          "## Step 4: Unified cross-stack conventions",
          "",
          "Using ALL the docs fetched above plus any crossQueries from tech-queries,",
