  ...
  server.registerTool(
    "generate-claude-md",
    {
      ...
      description: [
        ...
        "4. Cross-stack conventions: Using ALL the docs fetched above plus any crossQueries from tech-queries, produce ONE unified set of cross-stack rules.",
        ...
        "   Focus on rules that span multiple techs simultaneously. Put this in crossDocs under a single key 'all'.",
