...
const FRAMEWORK_PACKAGES = new Set([
  "next", "nuxt", "react", "react-dom", "astro", "vite", "express", "fastify", "hono",
  "@remix-run/react", "@remix-run/node", "@sveltejs/kit", "@solidjs/start",
]);
...
export class JavaScriptAdapter implements EcosystemAdapter {
  ...
  getFilePatterns(): EcosystemFilePatterns {
    const patterns = ECOSYSTEM_PATTERNS.javascript;
    return {
